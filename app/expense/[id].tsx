...
export default function ExpenseDetailScreen() {
  ...
  useEffect(() => {
    if (currentExpense) {
      ...
      setExchangeRate(currentExpense.exchange_rate.toString());
  ...
  if (isEditing) {
    return (
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        <Input label="金额" value={amount} onChangeText={setAmount} keyboardType="decimal-pad" />
        <CurrencyPicker label="货币" value={currency} onChange={setCurrency} />
        {currency !== currentProject?.base_currency && (
          <Input
        ...
        <Input label="地点" value={location} onChangeText={setLocation} />
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Card style={styles.card}>
        ...
        <Text style={styles.expenseAmount}>
          {formatCurrency(currentExpense.base_amount, currentProject?.base_currency ?? currentExpense.currency)}
        </Text>
        {currentExpense.currency !== currentProject?.base_currency && (
          <Text style={styles.originalAmount}>
            原始: {formatCurrency(currentExpense.amount, currentExpense.currency)} × {currentExpense.exchange_rate}
          </Text>
        )}
      </Card>
...
const styles = StyleSheet.create({
  ...
  originalAmount: { fontSize: fontSize.sm, color: colors.textSecondary, marginTop: spacing.xs },
